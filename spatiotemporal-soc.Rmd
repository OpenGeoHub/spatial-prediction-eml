...
```{r soc-depth, echo=TRUE, fig.width=8, out.width="90%", fig.cap="Distribution of values for SOC in g/kg vs soil depth."}
...
```{r soc-db, echo=TRUE, fig.width=8, out.width="90%", fig.cap="Distribution of values for SOC in g/kg vs soil bulk density."}
...
```{r soc-time, echo=TRUE, fig.width=8, out.width="90%", fig.cap="Distribution of training points through time."}
...
```{r eml-soc1, echo=FALSE, fig.cap="Accuracy plot for soil organic carbon fitted using Ensemble ML.", out.width="70%"}
