...
```{r predictions-fs, echo=TRUE, fig.width=8, out.width="100%", fig.cap="Predicted probability of occurrence for Fagus Sylvatica for three periods."}
...
knitr::include_graphics("./img/Fig_google_earth_prob_ts.jpg")
```
