...
```{r, pred-count, echo=FALSE, fig.width=6, fig.cap="Predictions of mosquito density over Europe with a zoom in on Spain.", out.width="90%"}
...
spplot(spain1km[[c(1,8,16,20)]], col.regions=SAGA_pal[[1]])
```
