...
```{r nohi-pred, echo=TRUE, fig.width=8, out.width="100%", fig.cap="Predicted Pb concentration using decomposition-composition PCA method with original covariates (left) and assuming no human influence (right)."}
